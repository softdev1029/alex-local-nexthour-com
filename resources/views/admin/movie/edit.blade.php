      	...
      	<div class="admin-form-block z-depth-1">
	        {!! Form::model($movie, ['method' => 'PATCH', 'action' => ['MovieController@update',$movie->id], 'files' => true]) !!}
              ...
              <div id="ready_url" class="form-group{{ $errors->has('ready_url') ? ' has-error' : '' }}">
                  ...
                  {!! Form::text('ready_url', $movie->video_link->ready_url, ['class' => 'form-control']) !!}
              ...
              <div id="custom_url">
                ...
                <div class="form-group{{ $errors->has('url_360') ? ' has-error' : '' }}">
                    ...
                    <p class="inline info"> - Please enter your video url</p>
                    {!! Form::text('url_360', $movie->video_link->url_360, ['class' => 'form-control']) !!}
                ...
                <div class="form-group{{ $errors->has('url_480') ? ' has-error' : '' }}">
                    ...
                    <p class="inline info"> - Please enter your video url</p>
                    {!! Form::text('url_480', $movie->video_link->url_480, ['class' => 'form-control']) !!}
                ...
                <div class="form-group{{ $errors->has('url_720') ? ' has-error' : '' }}">
                    ...
                    <p class="inline info"> - Please enter your video url</p>
                    {!! Form::text('url_720', $movie->video_link->url_720, ['class' => 'form-control']) !!}
                ...
                <div class="form-group{{ $errors->has('url_1080') ? ' has-error' : '' }}">
                    ...
                    <p class="inline info"> - Please enter your video url</p>
                    {!! Form::text('url_1080', $movie->video_link->url_1080, ['class' => 'form-control']) !!}
